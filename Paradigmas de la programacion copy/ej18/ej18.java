 ...
 */
    ...
    public static void rellenar3(int[] respuesta){
    ...
    public static int gen(int[] a){
        ...
        int numero = ra.nextInt(a.length+1);
        for (int i = 0; i < a.length; i++) {
            if(numero==a[i]){ repetido = true;
            break;
            }
        }
        if (repetido!=true){
    ...
    public static void RellenarSinRepetidos_Recursivo(int[] f)
    {
        int num = 0;
        boolean repetido = false;
